  ...
  render() {
    return (
      <div className="center-align">
        ...
        <div className="btn-large deep-purple lighten-2" id={this.props.lengthID}>
            {this.props.length}
        </div>
        <button
            className="btn-large deep-purple lighten-2"
    ...
    return (
      <div className="center-align">
        ...
        <div className="timer-control">
          <button id="start_stop" className="btn-large deep-purple lighten-2" onClick={this.timerControl}>
            <i className="material-icons">pause_circle_filled</i>
            <i className="material-icons">play_circle_filled</i>
          </button>
          <button id="reset" className="btn-large deep-purple lighten-2" onClick={this.reset}>
